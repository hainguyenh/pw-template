/**
 * verify-helper.ts: This module contains utility functions for assertions in tests.
...
import { getAlertText } from './ui-actions';
 ...
 */
export async function verifyElementToBeHidden(input: string | Locator, options?: ExpectOptions): Promise<void> {
 ...
 * @param {ExpectOptions} options - The options to pass to the expect function.
 */
export async function verifyElementToBeVisible(input: string | Locator, options?: ExpectOptions): Promise<void> {
  const { locator, assert } = getLocatorAndAssert(input, options);
 ...
 * @param {ExpectOptions} options - The options to pass to the expect function.
 */
export async function verifyElementToBeExisted(input: string | Locator, options?: ExpectOptions): Promise<void> {
  const { locator, assert } = getLocatorAndAssert(input, options);
 ...
 * @param {ExpectOptions} options - The options to pass to the expect function.
 */
export async function verifyElementToBeInViewport(input: string | Locator, options?: ExpectOptions): Promise<void> {
  const { locator, assert } = getLocatorAndAssert(input, options);
 ...
 * @param {ExpectOptions} options - The options to pass to the expect function.
 */
export async function verifyElementNotToBeInViewport(input: string | Locator, options?: ExpectOptions): Promise<void> {
  const { locator, assert } = getLocatorAndAssert(input, options);
 ...
 * @param {ExpectOptions} options - The options to pass to the expect function.
 */
export async function verifyElementToBeChecked(input: string | Locator, options?: ExpectOptions): Promise<void> {
  const { locator, assert } = getLocatorAndAssert(input, options);
 ...
 * @param {ExpectOptions} options - The options to pass to the expect function.
 */
export async function verifyElementNotToBeChecked(input: string | Locator, options?: ExpectOptions): Promise<void> {
  const { locator, assert } = getLocatorAndAssert(input, options);
 ...
 * @param {ExpectOptions} options - The options to pass to the expect function.
 */
export async function verifyElementToBeDisabled(input: string | Locator, options?: ExpectOptions): Promise<void> {
  const { locator, assert } = getLocatorAndAssert(input, options);
 ...
 * @param {ExpectOptions} options - The options to pass to the expect function.
 */
export async function verifyElementToBeEnabled(input: string | Locator, options?: ExpectOptions): Promise<void> {
  const { locator, assert } = getLocatorAndAssert(input, options);
 ...
 * @param {ExpectOptions} options - The options to pass to the expect function.
 */
export async function verifyElementToBeEditable(input: string | Locator, options?: ExpectOptions): Promise<void> {
  const { locator, assert } = getLocatorAndAssert(input, options);
 ...
 */
export async function verifyElementToHaveText(
 ...
 * @param {ExpectOptions & ExpectTextOptions} options - The options to pass to the expect function.
 */
export async function verifyElementNotToHaveText(
  input: string | Locator,
  text: string | RegExp | Array<string | RegExp>,
  options?: ExpectOptions & ExpectTextOptions,
): Promise<void> {
 ...
 * @param {ExpectOptions & ExpectTextOptions} options - The options to pass to the expect function.
 */
export async function verifyElementToContainText(
  input: string | Locator,
  text: string | RegExp | Array<string | RegExp>,
  options?: ExpectOptions & ExpectTextOptions,
): Promise<void> {
 ...
 * @param {ExpectOptions & ExpectTextOptions} options - The options to pass to the expect function.
 */
export async function verifyElementNotToContainText(
  input: string | Locator,
  text: string | RegExp | Array<string | RegExp>,
  options?: ExpectOptions & ExpectTextOptions,
): Promise<void> {
 ...
 * @param {ExpectOptions} options - The options to pass to the expect function.
 */
export async function verifyElementToHaveValue(
  input: string | Locator,
  text: string | RegExp,
 ...
 * @param {ExpectOptions} options - The options to pass to the expect function.
 */
export async function verifyElementToHaveValues(
  input: string | Locator,
 ...
 * @param {ExpectOptions} options - The options to pass to the expect function.
 */
export async function verifyElementValueToBeEmpty(input: string | Locator, options?: ExpectOptions): Promise<void> {
  const { locator, assert } = getLocatorAndAssert(input, options);
 ...
 * @param {ExpectOptions} options - The options to pass to the expect function.
 */
export async function verifyElementValueNotToBeEmpty(input: string | Locator, options?: ExpectOptions): Promise<void> {
  const { locator, assert } = getLocatorAndAssert(input, options);
 ...
 * @param {ExpectOptions} options - The options to pass to the expect function.
 */
export async function verifyElementToHaveAttribute(
  input: string | Locator,
  attribute: string,
  value: string | RegExp,
  options?: ExpectOptions,
 ...
 * @param {ExpectOptions} options - The options to pass to the expect function.
 */
export async function verifyElementToContainAttribute(
  input: string | Locator,
  attribute: string,
  value: string | RegExp,
  options?: ExpectOptions,
 ...
 * @param {ExpectOptions} options - The options to pass to the expect function.
 */
export async function verifyElementToHaveCount(
  input: string | Locator,
  count: number,
  options?: ExpectOptions,
): Promise<void> {
 ...
 */
export async function verifyPageToHaveURL(urlOrRegExp: string | RegExp, options?: ExpectOptions): Promise<void> {
  const assert = getExpectWithSoftOption(options);
 ...
 */
export async function verifyPageToContainURL(url: string, options?: ExpectOptions): Promise<void> {
  const assert = getExpectWithSoftOption(options);
 ...
 * @param {ExpectOptions} options - The options to pass to the expect function.
 */
export async function verifyPageToHaveTitle(titleOrRegExp: string | RegExp, options?: ExpectOptions): Promise<void> {
  const assert = getExpectWithSoftOption(options);
 ...
 * @returns {void}
 */
export function verifyPageSizeToBeEqualTo(numberOfPages: number, options?: SoftOption): void {
  const assert = getExpectWithSoftOption(options);
...
export async function verifyAlertToHaveText(
  input: string | Locator,
  text: string,
...
export async function verifyAlertToMatchText(
  input: string | Locator,
  text: string | RegExp,
  options?: ExpectOptions & TimeoutOption,
): Promise<void> {
